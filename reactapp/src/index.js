            ...
            <BasketContextProvider>
                <BrowserRouter>
                    <Switch>
                        ...
                        <AppRoute path="/gatunek/:filmtypeName" component={FilmtypeMovies} layout={BaseLayout}/>
                        ...
                        <AppRoute exact path="/rejestracja" component={Registration} layout={AuthLayout}/>
                        <AppRoute exact path="/oauth/google" component={GoogleAuth} layout={AuthLayout}/>
                        <AppRoute exact path="/oauth/facebook" component={FacebookAuth} layout={AuthLayout}/>
                        <Redirect to="/404"/>
                    </Switch>
                </BrowserRouter>
            </BasketContextProvider>
